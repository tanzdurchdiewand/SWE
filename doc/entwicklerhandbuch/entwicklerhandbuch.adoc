...
[plantuml,GemaeldeHandler,svg]
----
include::GemaeldeHandler.puml[]
----
...
[plantuml,GemaeldeService,svg]
----
include::GemaeldeService.puml[]
----
...
[plantuml,Gemaelde,svg]
----
include::Gemaelde.puml[]
----
